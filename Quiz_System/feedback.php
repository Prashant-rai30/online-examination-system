...
<div class="col-lg-6">
<span class="logo" href="https://www.youtube.com/channel/UCoqSjRl7lr2SFfwE-KV1uyQ" style="color: white;">ONLINE EXAM SYSTEM</span></div>
<div class="col-md-2">
</div>
<div class="col-md-4">
<?php
...
echo '<a href="#" class="pull-right sub1 btn title3" style="color:darkblue" data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-log-in" aria-hidden="true"></span>&nbsp;Signin</a>&nbsp;';}
else
{
echo '<a href="logout.php?q=feedback.php" style="color:#d82a4e" class="pull-right sub1 btn title3"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;Signout</a>&nbsp;';}
?>

<a href="index.php" class="pull-right btn sub1 title3" style="color:darkblue"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>&nbsp;Home</a>&nbsp;
</div></div>
  ...
  <div class="modal-dialog">
    <div class="modal-content title1">
      <div class="modal-header">
        ...
        <h4 class="modal-title title1"><span style="color:#d82a4e">Log In</span></h4>
      </div>
...
<h2 align="center" style="font-family:'typo'; color:darkblue;">FEEDBACK</h2>
...
<input type="submit" name="submit" value="Submit" class="btn btn-primary bttn" />
</div>
</form>';}?>
</div><!--col-md-6 end-->
...
<!--Footer start-->
<div class="row footer" style="position: fixed; width:1580px;">
